      ...
      <el-table
        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <div class="pro-member-con">
              <Autocomplete v-if="props.row.manager && props.row.manager._id == user._id"
              ...
              <div><label>项目成员：</label>
                ...
                <div class="member" v-for="(item,index) in props.row.members" title="项目成员">
                  ...
                  <span>{{item.name}}</span>
                  <i v-if="props.row.manager && props.row.manager._id == user._id" class="icon iconfont icon-shanchu1"
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <span v-if="scope.row.manager && user._id==scope.row.manager._id" class="operate"
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      getProCount(){
        this.api.get("/project/count", {userId: this.user._id}).then((res) => {
          if (res.status) {
      ...
      reload(){
        ...
        this.getProRelChartCount();
        Common.setProjects(this,this.user._id);
      },
      reset(){
        this.proItem = {
          name: "",
